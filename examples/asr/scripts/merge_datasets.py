...
output_file = "/projects/bhuang/corpus/speech/nemo_manifests/final/2023-11-21-normalized/train_asr.json"

input_file_paths = [
    "/projects/bhuang/corpus/speech/nemo_manifests/final/2023-11-21-normalized/test_mozilla-foundation_common_voice_13_0_manifest_normalized.json",
]
output_file = "/projects/bhuang/corpus/speech/nemo_manifests/final/2023-11-21-normalized/test_asr_mcv13_manifest_normalized.json"
...
#     # "/projects/bhuang/corpus/speech/nemo_manifests/facebook/multilingual_librispeech/french/test/test_facebook_multilingual_librispeech_manifest_normalized_pnc_cleaned.json",
#     # "/projects/bhuang/corpus/speech/nemo_manifests/facebook/voxpopuli/fr/test/test_facebook_voxpopuli_manifest_normalized_pnc.json",
#     # "/projects/bhuang/corpus/speech/nemo_manifests/google/fleurs/fr_fr/test/test_google_fleurs_manifest_normalized_pnc.json",
#     # "/projects/bhuang/corpus/speech/nemo_manifests/gigant/african_accented_french/test/test_gigant_african_accented_french_manifest_normalized_pnc_cleaned.json",
#     "/projects/bhuang/corpus/speech/nemo_manifests/mtedx/fr-fr/test/test_mtedx_manifest_normalized_pnc.json",
# ]
# # output_file = "/projects/bhuang/corpus/speech/nemo_manifests/final/2023-11-21/test_asr_mcv13_manifest_normalized_pnc.json"
# # output_file = "/projects/bhuang/corpus/speech/nemo_manifests/final/2023-11-21/test_asr_mls_manifest_normalized_pnc_cleaned.json"
# # output_file = "/projects/bhuang/corpus/speech/nemo_manifests/final/2023-11-21/test_asr_voxpopuli_manifest_normalized_pnc.json"
# # output_file = "/projects/bhuang/corpus/speech/nemo_manifests/final/2023-11-21/test_asr_fleurs_manifest_normalized_pnc.json"
# # output_file = "/projects/bhuang/corpus/speech/nemo_manifests/final/2023-11-21/test_asr_african_accented_french_manifest_normalized_pnc_cleaned.json"
# output_file = "/projects/bhuang/corpus/speech/nemo_manifests/final/2023-11-21/test_asr_mtedx_manifest_normalized_pnc.json"

column_names = {"text", "audio_filepath", "duration"}

datasets = []
for input_file_path in input_file_paths:
    ds = load_dataset("json", data_files=input_file_path, split="train")
